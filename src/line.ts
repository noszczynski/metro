...
export function find_line_by_name(name) {
...
export function find_line_by_html(html) {
...
export function lines_to_groups(lines) {
...
export function generate_draw_map(impacted_lines) {
...
export function generate_route_diagram(line) {

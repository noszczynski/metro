export function create_station_marker(id, latlng_orig) {
...
export function handle_map_click(e) {
...
export function delete_station_event(e) {
...
export function remove_line_from_station_event(e) {
...
export function build_to_station_event(e) {
